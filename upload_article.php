        ...
        <div class="container container-bg">
            ...
            <div class="d-flex justify-content-center pt-3 pb-5 mx-5">
                ...
                <div class="d-flex justify-content-center"> 
                    ...
                    <input type="text" class="form-control" placeholder="Straipsnio pavadinimas" id="usr"> 
                </div>  
            </div>      

            <div class="d-flex justify-content-center pt-3 pb-2 mx-5">    
                   <textarea class="form-control" placeholder="Įkelkite straipsnio tekstą čia..." rows="30"></textarea>  
            </div> 
